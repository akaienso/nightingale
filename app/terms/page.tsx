    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-3xl mx-auto px-4 py-10 space-y-8">
        ...
        <div className="text-center space-y-3">
          ...
          <h1 className="font-display font-bold text-2xl sm:text-3xl">{t('terms.title')}</h1>
          <p className="text-sm text-muted-foreground">{t('terms.lastUpdated')}</p>
        </div>

        {/* Intro */}
        <p className="text-base leading-relaxed text-foreground/90">{t('terms.intro')}</p>
        ...
        <div className="pt-6 border-t border-border">
          <div className="flex items-center gap-2 text-xs text-muted-foreground">
            ...
            <span>Nightingale &mdash; {t('terms.title')}</span>
          </div>
        </div>
      </main>
    </div>
